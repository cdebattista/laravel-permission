<template>
    <div>
        <div v-if="form" class="mb-6 flex justify-between items-center">
            ...
            <div v-can="createLinkPermission">
                <inertia-link v-if="createLink" class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded" :href="route(createLink)">
                    <span>Create </span>
                    <span class="hidden md:inline">{{ createLinkLabel }}</span>
                </inertia-link>
            </div>
        </div>
