                        ...
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <template v-if="$page.hasPermissionFeature">
                                        <div class="block px-4 py-2 text-xs text-gray-400">
                                            Groups & Permissions
                                        </div>

                                        <jet-dropdown-link v-can="canViewGroup" :href="groupIndex">
                                            Groups
                                        </jet-dropdown-link>

                                        <jet-dropdown-link v-can="canViewPermission" :href="permissionIndex">
                                            Permissions
                                        </jet-dropdown-link>

                                        <jet-dropdown-link v-can="canViewUser" :href="userIndex">
                                            Users
                                        </jet-dropdown-link>
    ...
    export default {
        ...
        data() {
            return {
                ...
                permissionIndex: this.route('permissions.index'),
                groupIndex: this.route('groups.index'),
                userIndex: this.route('users.index'),
                canViewGroup: ['administrator', 'view_group'],
                canViewPermission: ['administrator', 'view_permission'],
                canViewUser: ['administrator', 'view_user']
            }
        },
